...
If you want the higher-level reasoning for why Mountaineer is structured this way, see [Philosophy & Tradeoffs](../philosophy).
...
? Use uv for dependency management? [Yes] Yes
...
Let's get started by creating the data models that will persist app state to the database. These definitions are effectively Pydantic schemas that will be bridged to the database via [Iceaxe](https://github.com/piercefreeman/iceaxe).
...
from iceaxe import select, DBConnection
...
import { useServer, ServerState } from "./.mountaineer";
...
- [Configure your views and layouts](/guides/views)
- [Add more actions](/guides/actions)
- [Learn how to deploy your project to the web](/guides/deploy)
