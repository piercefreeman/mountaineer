...
We link to the local version of mountaineer in `pyproject.toml`. On the first install it should fetch dependencies with `uv` and then build the Rust components with `maturin`.
